...
public class Main {
    public static void main(String[] args) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(path))) {
            ...
            System.out.println("Пиковая посещаемость сайта (в секунду): " + stats.getPeakVisits());
            System.out.println("Список сайтов, со страниц которых есть ссылки на текущий сайт: " + stats.getReferer());
            System.out.println("Максимальная посещаемость одним пользователем: " + stats.getMaxVisitsByIP());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
